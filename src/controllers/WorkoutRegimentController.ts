...
import workoutRegimentService from "@services/workoutRegimentService";

const GET_LIST_CONTROLLER = async (req: Request, res: Response) => {
  try {
    const response = await workoutRegimentService.getList(req, res);
...
const GET_DETAIL_CONTROLLER = async (req: Request, res: Response) => {
  try {
    const response = await workoutRegimentService.getDetail(req, res);
    responseHandler(response.httpCode, response.message, response.data)(req, res);
  } catch (error: any) {
    errorHandler(HttpCode.INTERNAL_SERVER_ERROR, error.message)(req, res);
  }
...
const CREATE_CONTROLLER = async (req: Request, res: Response) => {
  try {
    const response = await workoutRegimentService.create(req, res);
    responseHandler(response.httpCode, response.message, response.data)(req, res);
  } catch (error: any) {
    errorHandler(HttpCode.INTERNAL_SERVER_ERROR, error.message)(req, res);
  }
...
const UPDATE_CONTROLLER = async (req: Request, res: Response) => {
  try {
    const response = await workoutRegimentService.update(req, res);
    responseHandler(response.httpCode, response.message, response.data)(req, res);
  } catch (error: any) {
    errorHandler(HttpCode.INTERNAL_SERVER_ERROR, error.message)(req, res);
  }
...
const DELETE_CONTROLLER = async (req: Request, res: Response) => {
  try {
    const response = await workoutRegimentService.deleteOne(req, res);
